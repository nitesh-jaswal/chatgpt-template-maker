...
# Taken from github gist: https://gist.github.com/b01/0a16b6645ab7921b0910603dfb85e4fb/#file-download-vs-code-server-sh
...
export PATH="$PATH:./.vscode-server/bin/${commit_sha}/bin"
